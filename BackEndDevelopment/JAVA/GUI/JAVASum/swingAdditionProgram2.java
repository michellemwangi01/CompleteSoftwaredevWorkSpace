...
public class swingAdditionProgram2 extends JFrame implements ActionListener {

    JTextField textField, textField2;
    JButton addButton, subButton;
    JTextField resultTextField;

    public swingAdditionProgram2() {
        ...
        setDefaultCloseOperation(swingAdditionProgram2.EXIT_ON_CLOSE);
        setVisible(true);
